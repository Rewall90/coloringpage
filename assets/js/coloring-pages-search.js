// Coloring Pages Search Implementation
class ColoringPagesSearch {
  constructor() {
    this.fuse = null;
    this.indexed = false;
    ...
    // DOM elements
    this.input = document.getElementById('coloring-pages-search-input');
    this.resultsContainer = document.getElementById('coloring-pages-search-results');
    this.resultsList = document.getElementById('coloring-pages-search-list');
    this.noResultsMessage = document.getElementById('coloring-pages-search-no-results');
  ...
  async buildIndex() {
    ...
    try {
      ...
      this.fuse = new Fuse(coloringPages, options);
      this.indexed = true;
    } catch (error) {
  ...
  highlightMatches(text, matches) {
    ...
    sortedIndices.forEach(([start, end]) => {
      ...
      // Add highlighted match (disabled highlighting in CSS)
...
document.addEventListener('DOMContentLoaded', () => {
  if (document.getElementById('coloring-pages-search-input')) {
    new ColoringPagesSearch();
  }
});